...
def main():
    ...
    #results = query_by_name(ARTIST_URL, query_type["simple"], "胡彦斌")
    
    #results = query_by_name(ARTIST_URL, query_type["simple"], "first aid kit")
    #pretty_print(len(results)) #
    
    #results = query_by_name(ARTIST_URL, query_type["simple"], "Queen")  
    #pretty_print(results["artists"][0]['begin-area']['name']) #London
    
    #results = query_by_name(ARTIST_URL, query_type["simple"], "Beatles")
    #pretty_print(results["artists"][0]['aliases']) #Los Beatles
     # {
     #        "begin-date": null,
     #        "end-date": null,
     #        "locale": "es",
     ...
     #    },
    #results = query_by_name(ARTIST_URL, query_type["simple"], "Nirvana")
    #pretty_print((results["artists"][3]["disambiguation"])) #’70s French band from Martigues

    results = query_by_name(ARTIST_URL, query_type["simple"], "one direction")

    pretty_print((results["artists"][0]["life-span"])) #2010-07
